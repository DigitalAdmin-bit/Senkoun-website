        ...
        <footer className="bg-[#57946C] pb-10">
            <div className="w-[70%] mx-auto pt-10">
                ...
                <div className="flex justify-between my-8">
                    <div className="space-x-5">
                        <input
                            ...
                            className="bg-white/10 placeholder-white/60 border-[#FFFFFF4D] border-2 text-[#FFFFFF]/70 px-4 py-2 "
                        />
                        <input
                    ...
                    <button
                        className="font-normal text-white text-sm hover:opacity-80 flex items-center opacity-80"
                    >
                        SUBSCRIBE
                ...
                <div className="flex justify-between gap-5 mb-10">
                    <div className="flex mx-10 flex-col justify-between items-cente">
                        <img
                            className="w-41.5"
                            alt="Senkoun logo"
                            src="/logo-white.webp"
                        ...
                        <Link href="#" className="mx-auto text-white border-white border px-4 py-2 mt-4 inline-block w-fit">
                            ENQUIRE
                        </Link>
                    </div>

                    <div className="border-white/20 border-l-2 min-h-full"/>
                    ...
                    <nav className="mr-10 ml-10 flex flex-col gap-2">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-10">
                        ...
                        <p className="font-light text-white text-base tracking-[0] leading-6">
