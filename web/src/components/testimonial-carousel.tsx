  ...
  return (
    <div className="flex items-center justify-center">
      <div className="relative main-container">
        <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 z-10 bg-[#fbf5f3] border border-[#64565A] quote-mark w-16 h-16 rounded-full flex items-center justify-center">
          <svg
            width="27"
            height="20"
            viewBox="0 0 27 20"
        ...
        <div className="relative border border-[#64565A] px-12 py-16 md:px-20 md:py-24">
          ...
          <div className="relative flex items-center justify-center">
            ...
            >
              <blockquote className="text-center font-heading text-[#64565A] leading-relaxed mb-12 text-lg md:text-xl px-4">
          ...
          {/* Navigation */}
          <div className="flex items-center justify-center gap-6 absolute -bottom-5 left-1/2 transform -translate-x-1/2 z-10">
            <button
