    ...
    <div className="w-full max-w-2xl mx-auto p-6">
      <Accordion.Root type="single" collapsible className="w-full">
        {items.map((item, index) => (
          ...
          >
            <Accordion.Header>
              <Accordion.Trigger className="flex w-full items-center gap-5 py-6 text-left transition-all hover:opacity-70 group">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                <span className="text-lg font-normal text-gray-400 group-data-[state=open]:text-gray-800 transition-colors">
                  {item.title}
                </span>
              </Accordion.Trigger>
            </Accordion.Header>
