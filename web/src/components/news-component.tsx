    ...
    return (
        ...
        >
            <SectionHeader
                ...
                rightLink="#"
            />
            <div className="max-sm:flex max-sm:gap-5 max-sm:pb-10 max-sm:w-full max-sm:overflow-x-scroll max-sm:overflow-y-hidden max-sm:flex-nowrap sm:grid sm:grid-cols-3 sm:gap-10">
                {newsArticles.map((article, index) => (
                    <div key={index} className="max-sm:min-w-full border-0 shadow-none bg-transparent">
