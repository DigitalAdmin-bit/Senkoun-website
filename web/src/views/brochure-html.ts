...
<body>
    <div class="email-container">
        <!-- Header -->
        <div class="header">
            <h1>New Brochure Download Request</h1>
        </div>

        <!-- Content -->
        <div class="content">
            <div class="notification-label">New Request Notification</div>
            
            <p class="message">
                A new brochure download request has been submitted through your website. 
                Please review the contact details below and follow up with the potential client accordingly.
            </p>
            ...
            <div class="action-section">
                <p>
                    ...
                    It is recommended to contact this potential client within 24 hours to discuss their requirements 
                    and provide additional information about your care services.
                </p>
            </div>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 15px;">
                This email was automatically generated in response to a brochure download request 
