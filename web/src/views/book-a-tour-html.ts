...
<head>
    ...
    <title>New Book A Tour Request</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        <!-- Header -->
        <div class="header">
            <h1>New Book A Tour Request</h1>
        </div>

        <!-- Content -->
        <div class="content">
            <div class="notification-label">Tour Booking Request</div>
            
            <p class="message">
                A new tour booking request has been submitted through your website. 
                Please review the details below and schedule the facility tour accordingly.
            </p>
            ...
            <table class="details-table">
                ...
                <tr class="highlight-row">
                    ...
                    <td class="detail-value">{preferred_date}</td>
                </tr>
                <tr class="highlight-row">
                    <td class="detail-label">Preferred Time:</td>
                    <td class="detail-value">{preferred_time}</td>
                </tr>
            </table>
            ...
            <div class="action-section">
                <p>
                    ...
                    Please contact this client to confirm the facility tour at their preferred date and time. 
                    Ensure all necessary preparations are made for a professional tour experience.
                </p>
            </div>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 15px;">
                This email was automatically generated in response to a tour booking request 
