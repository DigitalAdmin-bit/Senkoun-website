...
<head>
    ...
    <title>New Book A Call Request</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        ...
        <!-- Content -->
        <div class="content">
            <div class="notification-label">Call Booking Request</div>
            
            <p class="message">
                A new call booking request has been submitted through your website. 
                Please review the details below and schedule the call accordingly.
            </p>
            ...
            <div class="action-section">
                <p>
                    ...
                    Please contact this client to confirm the call appointment at their preferred date and time. 
                    If the requested time is not available, offer alternative slots.
                </p>
            </div>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 15px;">
                This email was automatically generated in response to a call booking request 
